...
$(document).ready(function() {
	...
	if(type == "about_menager" || type == "privacy" || type == "contact_info" || type == "contact_apply"){
		$("#enli, #enDiv").hide();
	}
	else if(type == "about_responsibility" || type == "about_fuDir" ){
//		$("#tabs").tabs( "option", "active", 1 ); //跳往第二個tab
		$("#tabs").tabs( {active : 1} )
		$("#chli, #chDiv").hide();
	}
