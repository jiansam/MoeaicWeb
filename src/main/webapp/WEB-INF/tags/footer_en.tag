...
<div id="divFatFooter">
	<a id="Z" href="#Z" accesskey="Z" class="sr-only z-focusable" style="float:left;" title="Bottom menu">:::</a>
	<div class="container">
		<div id="divFatFooterTool">
			...
			<div class="cell">
				<dl>
					...
					<dt><a href="${pageContext.request.contextPath}/english/FAQ_EN.jsp" title="FAQs">FAQs</a></dt>					
					<dt><a href="${pageContext.request.contextPath}/links.view?do=index&lang=en" title="Related Links">Related Links</a></dt>
				</dl>
			</div>
			<div class="cell">
				<dl>
					...
					<dd>
						<ul>
							...
							<li><a href="${pageContext.request.contextPath}/businessPub.view?lang=en&op_id_one=8" title="Other">Other</a></li>
						</ul>
					</dd>
				</dl>
			</div>
...
<div id="divPageBottom">
	<div class="container">
		...
		<div class="information_logo">
			...
			<div class="information_image">
				<a href="http://www.gov.tw/" target="_blank" title="[Open in a new window]taiwan.gov.tw">
					<img src="${pageContext.request.contextPath}/images/e_gov.gif" alt="[Open in a new window]taiwan.gov.tw" />
				</a>
			</div>
		</div>
	</div>
