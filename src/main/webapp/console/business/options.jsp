...
%>
										<tr>
											...
											<td nowrap>
												...
												/></a>
												<a href="#" onclick="doRemove('<%= option.getId() %>' , 'PB')">
...
%>
            ...
            <div class="row">
				<div class="col-lg-12" >
					<input type="button" value="新增中文常見問題分類" class="btn btn-primary" 
						onclick="edit_options(0, 'ch_QA_type');" style="float:right;margin-bottom:5px;"/>
				</div>
			</div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">中文常見問題分類列表</div>
                        
                        <!-- /.panel-heading --> 
                        <div class="panel-body" >
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="web_TitleList_CH">
                                    <thead>
                                        <tr>
                                            <th width="5%">順序</th>
                                            <th>中文名稱</th>
                                    ...
                                    <tbody id="rows">
<%
									for(Option option : OptionDAO.listByType("ch_QA_type")){
%>
										<tr>
											<td><%= option.getSeq() %></td>
											<td><%= option.getName() %></td>
											<td nowrap>
												<a href="javascript:void(0);" onclick="edit_options(<%= option.getId() %>, 'ch_QA_type');">
													<img class="edit" src="${pageContext.request.contextPath}/images/icons/edit.png" width="24"></a>
												<a href="delete-options.jsp?id=<%= option.getId() %>" >
...
%>
            ...
            <div class="row">
				<div class="col-lg-12" >
					<input type="button" value="新增英文常見問題分類" class="btn btn-primary" 
						onclick="edit_options(0, 'en_QA_type');" style="float:right;margin-bottom:5px;"/>
				</div>
			</div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">英文常見問題分類列表</div>
                        
                        <!-- /.panel-heading --> 
                        <div class="panel-body" >
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="web_TitleList_EN">
                                    <thead>
                                        <tr>
                                            <th width="5%">順序</th>
                                            <th>英文名稱</th>
                                    ...
                                    <tbody id="rows">
<%
									for(Option option : OptionDAO.listByType("en_QA_type")){
%>
										<tr>
											<td><%= option.getSeq() %></td>
											<td><%= option.getEname() %></td>
											<td nowrap>
												<a href="javascript:void(0);" onclick="edit_options(<%= option.getId() %>, 'en_QA_type');">
													<img class="edit" src="${pageContext.request.contextPath}/images/icons/edit.png" width="24"></a>
												<a href="delete-options.jsp?id=<%= option.getId() %>" >
													<img class="dele" src="${pageContext.request.contextPath}/images/icons/action_delete.gif" width="24"></a>
											</td>
...
%>
    ...
    <div id="QA-dialog" title="編輯常見問題分類"></div>
<console:footer />    
</body>
</html>