...
<head>
	...
	<script type="text/javascript">
		...
		var type = "${pagesOne_ch.type}" //op_id
	</script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/console/flow-Chart.js"></script>
</head>
                    ...
                    <div class="panel panel-default">
                    	<div id="tabs">
							<ul class="tabLi">
								...
								<li id="enli" style="display:none;"><a href="#enDiv">英文版</a></li>
							</ul>
		                        ...
		                        <div class="panel-heading">
		                        	...
		                        	<table class="pure-table pure-table-striped" style="width:100%;border:1pa solid red;">
		                        		...
		                        		<tr>
		                        			<td align="center">
		                        				<br>
		                        				<input type="hidden" name="type" value="${pagesOne_ch.type==null ? op_id : pagesOne_ch.type}">
								...
								<div class="panel-heading">
								    ...
								    <table class="pure-table pure-table-striped" style="width:100%;border:1pa solid red;">
								    	...
								    	<tr>
								        	<td align="center">
								            	<br>
								           		<input type="hidden" name="type" value="${pagesOne_en.type==null ? op_id : pagesOne_en.type}">
