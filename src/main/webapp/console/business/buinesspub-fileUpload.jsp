...
$(function() {
	...
	.bind('fileuploadsubmit', function (e, data) {  
		data.formData = {				//submit時帶走的資料
			doThing: $('#doThing').val(), //newBPFile_ch
			businessPub_id: $('#businessPub_id').val(),
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										<input type="hidden" id="businessPub_id" name="businessPub_id" value="">
