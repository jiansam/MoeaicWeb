		...
		$(document).ready(function() {
	        $('#pagesNewsList').DataTable({
	            ...
	            "ajax" : {
					url : pagesURL ,
					cache : false,
					data : { "type" : "business_ann" , "doThing" : "getAll_business_ann" } // -- 每頁必須修改處  --
				},
	        });
...
<body>
	<div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header"><b>業務統計</b></h2> <!-- 每頁必須修改處    -->
                </div>
            </div>
            ...
            <div class="row">
				<div class="col-lg-12" >
					<c:url value="/console/edit-pages.view" var="add" scope="page">
						...
						<c:param name="type"  value="business_ann"/>   <!-- 每頁必須修改處    -->
					</c:url>				
					<a href="${add}">
						<input type="button" value="新增業務統計" class="btn btn-primary" 
