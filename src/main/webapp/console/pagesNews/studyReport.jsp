		...
		$(document).ready(function() {
	        $('#pagesNewsList').DataTable({
	            ...
	            "ajax" : {
					url : pagesURL ,
					cache : false,
					data : { "type" : "studyReport" , "doThing" : "getAll_studyReport" } // -- 每頁必須修改處  --
				},
	        });
...
<body>
	<div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header"><b>研究報告</b></h2> <!-- 每頁必須修改處    -->
                </div>
            </div>
            ...
            <div class="row">
				<div class="col-lg-12" >
					<c:url value="/console/edit-pages.view" var="add" scope="page">
						...
						<c:param name="type"  value="studyReport"/>   <!-- 每頁必須修改處    -->
					</c:url>				
					<a href="${add}">
						<input type="button" value="新增研究報告" class="btn btn-primary" 
